...
def common_arg_parser():
    ...
    parser.add_argument('--res', default="100x100", type=str)
    parser.add_argument('--num_trajectories', default=640, type=int)
    parser.add_argument('--num_length', default=800, type=int)
    parser.add_argument('--stack', default=1, type=int)
    parser.add_argument('--skip', default=4, type=int)
    parser.add_argument('--render', default=False, action='store_true')
    parser.add_argument('--mode', default="wp_obj", type=str)
    parser.add_argument('--feature', default="wp_car", type=str)
    return parser
